...
import 'package:test_ui/cubits/add_screen_cubit/add_screen_cubit.dart';
...
import 'package:test_ui/views/settings.dart';
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => MultiBlocProvider(
                          providers: [
                            ...
                            BlocProvider(
                              create: (context) =>
                                  AddScreenCubit()..loadInitialData(),
                            )
                          ],
                          child: Add_Screen(),
                        )));
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Icon(
                        ...
                        size: 30,
                        color:
                            index == 0 ? const Color(0xff368983) : Colors.grey,
                      ),
                    ),
                    GestureDetector(
                      onTap: () {
                      ...
                      child: Icon(
                        ...
                        size: 30,
                        color:
                            index == 1 ? const Color(0xff368983) : Colors.grey,
                      ),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: Icon(
                        ...
                        size: 30,
                        color:
                            index == 2 ? const Color(0xff368983) : Colors.grey,
                      ),
                    ),
                    GestureDetector(
                      onTap: () {
                        context
                            ...
                            .selectIndex(3); // Navigate to Profile
                      },
                      child: Icon(
                        Icons.settings,
                        size: 30,
                        color:
                            index == 3 ? const Color(0xff368983) : Colors.grey,
                      ),
                    ),
                  ],
                ),
